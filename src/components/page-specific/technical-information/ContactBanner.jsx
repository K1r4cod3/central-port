    ...
    <div className='py-16'>
       <div className='container mx-auto px-4 md:px-6'>
            <div className='max-w-3xl mx-auto text-center'>
                ...
                Cần thêm thông tin kỹ thuật hoặc hỗ trợ cho hoạt động của bạn? 
                </h2>
                <p className='text-lg mb-8 content-font'>
                Liên hệ với chúng tôi ngay hôm nay để tìm hiểu cách Cảng Nước Sâu Miền Trung có thể hỗ trợ nhu cầu hàng hải của bạn!
                </p>
