       ...
       <div className='container mx-auto px-4 md:px-6'>
            <div className='max-w-3xl mx-auto text-center'>
                <h2 className='text-2xl md:text-4xl font-bold mb-4 title-font'>
                    Bạn đang tìm kiếm giải pháp neo đậu và kho bãi đáng tin cậy? 
                </h2>
                <p className='text-lg mb-8 content-font'>
                    Liên hệ với chúng tôi ngay hôm nay để tìm hiểu thêm về cách chúng tôi có thể hỗ trợ hoạt động hàng hải và logistics của bạn!
                </p>
