...
export const NewsBanner = () => {
  return (
    <div className="mx-auto mb-[60px] md:mb-[90px] max-w-[1440px] w-full px-4 md:px-0">
      <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-6 md:mb-8">Latest News</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* News Item 1 */}
        <div className="flex flex-col">
          <img src={new1 || "/placeholder.svg"} alt="News 1" className="w-full h-48 object-cover rounded-lg mb-4" />
        ...
        {/* News Item 2 */}
        <div className="flex flex-col">
          <img src={new2 || "/placeholder.svg"} alt="News 2" className="w-full h-48 object-cover rounded-lg mb-4" />
        ...
        {/* News Item 3 */}
        <div className="flex flex-col">
          <img src={new3 || "/placeholder.svg"} alt="News 3" className="w-full h-48 object-cover rounded-lg mb-4" />
          <span className="text-gray-500 text-sm mb-2">19/3/2025</span>
          <h3 className="text-base md:text-lg font-bold text-gray-800 mb-2">
        ...
        {/* News Item 4 */}
        <div className="flex flex-col">
          <img src={new4 || "/placeholder.svg"} alt="News 4" className="w-full h-48 object-cover rounded-lg mb-4" />
          <span className="text-gray-500 text-sm mb-2">19/3/2025</span>
          <h3 className="text-base md:text-lg font-bold text-gray-800 mb-2">
