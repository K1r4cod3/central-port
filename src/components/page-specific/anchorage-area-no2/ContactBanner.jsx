    ...
    <div className='py-16'>
       <div className='container mx-auto px-4 md:px-6'>
            <div className='max-w-3xl mx-auto text-center'>
                ...
                Bạn đã sẵn sàng sử dụng Khu vực neo đậu số 2 cho tàu của mình?  
                </h2>
                <p className='text-lg mb-8 content-font'>
                Liên hệ với chúng tôi ngay hôm nay để biết thêm chi tiết hoặc đặt lịch hoạt động tại Cảng Nước Sâu Miền Trung!
                </p>
